...
final object HList {
  ...
  implicit def hnilShape[Level <: ShapeLevel]: slick.collection.heterogeneous.HList.HListShape[Level,slick.collection.heterogeneous.HNil.type,slick.collection.heterogeneous.HNil.type,slick.collection.heterogeneous.HNil.type] = new HListShape[Level, HNil.type, HNil.type, HNil.type](Nil)
  implicit def hconsShape[Level <: ShapeLevel, M1, M2 <: HList, U1, U2 <: HList, P1, P2 <: HList](implicit s1: Shape[_ <: Level, M1, U1, P1], s2: HListShape[_ <: Level, M2, U2, P2]): slick.collection.heterogeneous.HList.HListShape[Level,slick.collection.heterogeneous.syntax.::[M1,M2],slick.collection.heterogeneous.syntax.::[U1,U2],slick.collection.heterogeneous.syntax.::[P1,P2]] =
