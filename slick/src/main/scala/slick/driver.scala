...
import slick.jdbc.{ DerbyProfile, H2Profile, HsqldbProfile, JdbcCapabilities, MySQLProfile, PostgresProfile, SQLiteProfile }
package object driver {
  ...
  object JdbcProfile {
    ...
    val capabilities: JdbcCapabilities.type = slick.jdbc.JdbcCapabilities
  }
  ...
  val DerbyDriver: DerbyProfile.type = slick.jdbc.DerbyProfile
  ...
  val H2Driver: H2Profile.type = slick.jdbc.H2Profile
  ...
  val HsqldbDriver: HsqldbProfile.type = slick.jdbc.HsqldbProfile
  ...
  val MySQLDriver: MySQLProfile.type = slick.jdbc.MySQLProfile
  ...
  val PostgresDriver: PostgresProfile.type = slick.jdbc.PostgresProfile
  ...
  val SQLiteDriver: SQLiteProfile.type = slick.jdbc.SQLiteProfile
}
