...
final case class CollectionType(
    cons: CollectionTypeConstructor, elementType: Type) extends Type {
...
abstract class TypedCollectionTypeConstructor[C[_]](
    val classTag: ClassTag[C[_]]) extends CollectionTypeConstructor {
  override def toString =
...
final class MappedScalaType(val baseType: Type,
                            ...
                            val classTag: ClassTag[_]) extends Type {
