  ...
  def seq[E <: Effect](
    ...
    def sequenceSync(g: Vector[DBIOAction[Any, NoStream, E]]
      ...
      new SynchronousDatabaseAction.Fused[Unit, NoStream, BasicBackend, E] {
        def run(context: BasicBackend#Context) = {
          g.foreach(_.asInstanceOf[SynchronousDatabaseAction[Any,
                                                             NoStream,
                                                             BasicBackend,
                                                             E]].run(context))
        }
...
case class FlatMapAction[+R, +S <: NoStream, P, -E <: Effect](
    ...
    executor: ExecutionContext) extends DBIOAction[R, S, E] {
  def getDumpInfo =
...
case class AndThenAction[R, +S <: NoStream, -E <: Effect](
    as: IndexedSeq[DBIOAction[Any, NoStream, E]]) extends DBIOAction[R, S, E] {
  def getDumpInfo =
...
case class SequenceAction[R, +R2, -E <: Effect](
    ...
    implicit val cbf: CanBuild[R, R2]) extends DBIOAction[R2, NoStream, E] {
  def getDumpInfo =
...
case class NamedAction[+R, +S <: NoStream, -E <: Effect](
    a: DBIOAction[R, S, E], name: String) extends DBIOAction[R, S, E] {
      ...
      a match {
        case a: SynchronousDatabaseAction.FusedAndThenAction [_, _, _, _] =>
          new SynchronousDatabaseAction.FusedAndThenAction[
              R2, S2, B, E with E2](
              as.asInstanceOf[IndexedSeq[SynchronousDatabaseAction[
                          Any, S2, B, E with E2]]] ++ a.as
                .asInstanceOf[IndexedSeq[SynchronousDatabaseAction[
                          Any, S2, B, E with E2]]])
        case a: SynchronousDatabaseAction [_, _, _, _] =>
          new SynchronousDatabaseAction.FusedAndThenAction[
              R2, S2, B, E with E2](
              as.asInstanceOf[IndexedSeq[SynchronousDatabaseAction[
                          Any, S2, B, E with E2]]] :+ a.asInstanceOf[
