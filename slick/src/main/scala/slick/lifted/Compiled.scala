...
object Executable {
  @inline implicit def queryIsExecutable[B, BU, C[_]]: slick.lifted.StreamingExecutable[slick.lifted.Query[B,BU,C],C[BU],BU] = StreamingExecutable[Query[B, BU, C], C[BU], BU]
  @inline implicit def tableQueryIsExecutable[B <: AbstractTable[_], BU, C[_]]: slick.lifted.StreamingExecutable[slick.lifted.Query[B,BU,C] with slick.lifted.TableQuery[B],C[BU],BU] = StreamingExecutable[Query[B, BU, C] with TableQuery[B], C[BU], BU]
  @inline implicit def baseJoinQueryIsExecutable[B1, B2, BU1, BU2, C[_], Ba1, Ba2]: slick.lifted.StreamingExecutable[slick.lifted.BaseJoinQuery[B1,B2,BU1,BU2,C,Ba1,Ba2],C[(BU1, BU2)],(BU1, BU2)] = StreamingExecutable[BaseJoinQuery[B1, B2, BU1, BU2, C, Ba1, Ba2], C[(BU1, BU2)], (BU1, BU2)]
