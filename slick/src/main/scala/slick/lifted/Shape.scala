...
trait AbstractTableShapeImplicits extends RepShapeImplicits {
  @inline implicit final def tableShape[Level >: FlatShapeLevel <: ShapeLevel, T, C <: AbstractTable[_]](implicit ev: C <:< AbstractTable[T]): slick.lifted.Shape[Level,C,T,C] = RepShape[Level, C, T]
}
...
trait ConstColumnShapeImplicits extends RepShapeImplicits {
  ...
  @inline implicit def constColumnShape[T, Level <: ShapeLevel]: slick.lifted.Shape[Level,slick.lifted.ConstColumn[T],T,slick.lifted.ConstColumn[T]] = RepShape[Level, ConstColumn[T], T]
}

trait RepShapeImplicits extends OptionShapeImplicits {
  /** A Shape for single-column Reps. */
  @inline implicit def repColumnShape[T : BaseTypedType, Level <: ShapeLevel]: slick.lifted.Shape[Level,slick.lifted.Rep[T],T,slick.lifted.Rep[T]] = RepShape[Level, Rep[T], T]
...
object ShapedValue {
  @inline implicit def shapedValueShape[T, U, Level <: ShapeLevel]: slick.lifted.Shape[Level,slick.lifted.ShapedValue[T,U],U,slick.lifted.ShapedValue[T,U]] = RepShape[Level, ShapedValue[T, U], U]
...
object MappedProjection {
  ...
  @inline implicit final def mappedProjectionShape[Level >: FlatShapeLevel <: ShapeLevel, T, P]: slick.lifted.Shape[Level,slick.lifted.MappedProjection[T,P],T,slick.lifted.MappedProjection[T,P]] = RepShape[Level, MappedProjection[T, P], T]
}
